...
sgn_carefully sgn_builddir sgn_byuser sh -c "echo \"XLDFLAGS=$LDFLAGS\" >> Makefile.new"
...
sgn_carefully sgn_builddir sgn_byuser sh -c "echo \"LDFLAGS=$LDFLAGS\" >> librtmp/Makefile.new"
