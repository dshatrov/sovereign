...
PACKAGE_VERNAME="glib-networking-2.28.7"
...
sgn_carefully sgn_builddir sgn_byuser sh -c "LD_LIBRARY_PATH=\"$SGN_PREFIX/lib:$LD_LIBRARY_PATH\" ./configure --prefix=\"$SGN_PREFIX\""
